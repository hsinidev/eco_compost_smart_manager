<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Eco%20Compost%20Smart%20Manage&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Eco Compost Smart Manager Header Banner" />

  <h1>🚀 Eco Compost Smart Manager</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/eco_compost_smart_manager"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Eco Compost Smart Manager** delivers a fast, responsive, and cross-platform browser experience built with **HTML** and hardware-accelerated canvas rendering.
...
```bash
git clone https://github.com/hsinidev/eco_compost_smart_manager.git
cd eco_compost_smart_manager
```
